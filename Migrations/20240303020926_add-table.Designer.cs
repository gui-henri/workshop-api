...
namespace WorkshopApi.Migrations
{
    ...
    [Migration("20240303020926_add-table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollaboratorWorkshop", b =>
                {
                    ...
                    b.HasKey("CollaboratorsId", "WorkshopsId");

                    b.HasIndex("WorkshopsId");

                    b.ToTable("WorkshopCollaborator", (string)null);
                });
            ...
            modelBuilder.Entity("CollaboratorWorkshop", b =>
                {
                    b.HasOne("WorkshopApi.Entities.Collaborator", null)
                        .WithMany()
                        .HasForeignKey("CollaboratorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WorkshopApi.Entities.Workshop", null)
                        .WithMany()
